...
function Professional() {
    ...
    return (
      ...
      <div className="professional-grid-container" data-testid="professional-grid-container">
                ...
                <Fragment key={`xp-${companyIndex}-${projectIndex}`}>
                  ...
                  {companyIndex === 0 && projectIndex === 0 &&
                    <div className="professional-info-grid-logo" data-testid="professional-experience-logo">
                      <img src={require(`../../assets/images/${company.toLowerCase()}.png`)} alt={company.toLowerCase()} title={company.toLowerCase()} data-testid={`company_logo`} style={logoStyles} />
                    </div>
                  }
                </Fragment>
              )
        ...
        <div className="professional-info-grid-container" data-testid="professional-driving-container">
          ...
          <div className="professional-info-grid-date" data-testid="professional-info-grid-date"></div>
  ...
  const renderProfessionalData = () => {
    return errorState ? showProfessionalError() : showProfessionalData();
  }
